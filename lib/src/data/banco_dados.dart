...
class BancoDados {
  ...
  List<Servico> listaServicos = [
    Servico(
        ...
        idCadastrador: 1,
        nome: "Desentupir Pia",
        descricao: "Desentupimento completo de pia",
        preco: 155.5),
    Servico(
      id: 1,
      idCadastrador: 1,
      nome: "Faxina de quarto",
      descricao: "Faxina completa de um quarto ",
      preco: 96.3,
    ),
    Servico(id: 2, idCadastrador: 1, nome: 'Manicure', descricao: 'Fazer as unhas', preco: 50,)
  ];
  ...
  Servico buscaServico(int id) {
    return listaServicos.firstWhere((servico) => servico.id == id,
        orElse: () => throw Error());
  }
  ...
  Usuario buscaUsuario(String id) {
    return listaUsuarios.firstWhere((usuario) => usuario.id == id,
        orElse: () => throw Error());
  }
